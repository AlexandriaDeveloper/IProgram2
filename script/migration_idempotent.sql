...
BEGIN
    ...
    VALUES (N'20240815134033_Init', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240819221452_Daily-Relation-fix', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240819222322_Department-Relation-fix', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250815185021_Add-Review-Field', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250907211723_Add-DailyReference', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260227150824_AddSummaryReviewFields', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260227162856_AddSummaryComment', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260310112020_AddFormDetailsFormIdIndex', N'8.0.11');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260310215854_AddEmployeeNetPay', N'8.0.11');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260422085815_AddFormDailyIdIndex'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260422085815_AddFormDailyIdIndex', N'8.0.11');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260510185130_AddEmployeeWatchList'
)
BEGIN
    CREATE TABLE [EmployeeWatchLists] (
        [Id] int NOT NULL IDENTITY,
        [EmployeeId] nvarchar(14) NULL,
        ...
        [DeactivatedAt] datetime2 NULL,
        [IsActive] bit NOT NULL,
        CONSTRAINT [PK_EmployeeWatchLists] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_EmployeeWatchLists_Employees_EmployeeId] FOREIGN KEY ([EmployeeId]) REFERENCES [Employees] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE INDEX [IX_EmployeeWatchLists_EmployeeId] ON [EmployeeWatchLists] ([EmployeeId]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260510185130_AddEmployeeWatchList', N'8.0.11');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260917213000_AddSummaryReviewMethod'
)
BEGIN
    ALTER TABLE [FormDetails] ADD [SummaryReviewMethod] nvarchar(20) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260917213000_AddSummaryReviewMethod', N'8.0.11');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260918185849_OptimizeHotPathIndexesSprint4B'
)
BEGIN
    DROP INDEX [IX_FormDetails_FormId] ON [FormDetails];
END;
GO
...
BEGIN
    DROP INDEX [IX_Form_DailyId] ON [Form];
END;
GO
...
BEGIN
    CREATE INDEX [IX_FormDetails_FormId_IsActive_EmployeeId] ON [FormDetails] ([FormId], [IsActive], [EmployeeId]) INCLUDE ([Amount], [OrderNum]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Form_DailyId_IsActive_Index] ON [Form] ([DailyId], [IsActive], [Index]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Form_IsActive_CreatedAt] ON [Form] ([IsActive], [CreatedAt]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260918185849_OptimizeHotPathIndexesSprint4B', N'8.0.11');
END;
GO

...
namespace Auth.Infrastructure.Sync
{
    ...
    public class ReadOnlyDbConnectionInterceptor : DbConnectionInterceptor
    {
        ...
        {
            if (_syncConnectionProvider == null || (!_syncConnectionProvider.IsLocalFirstEnabled && !_syncConnectionProvider.IsReadOnlyMode && !_syncConnectionProvider.IsLocalOnlyProduction))
            {
                return;
            }

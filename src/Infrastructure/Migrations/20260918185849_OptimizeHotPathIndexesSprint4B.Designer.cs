...
namespace Auth.Infrastructure.Migrations
{
    ...
    [Migration("20260918185849_OptimizeHotPathIndexesSprint4B")]
    partial class OptimizeHotPathIndexesSprint4B
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.DailyReference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EmployeeNetPay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DailyReferenceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.EmployeeWatchList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.Form", b =>
                {
                    ...
                    b.HasIndex("DailyId", "IsActive", "Index")
            ...
            modelBuilder.Entity("Core.Models.FormDetails", b =>
                {
                    ...
                    b.Property<string>("IsReviewedBy")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<bool>("IsSummaryReviewed")
                        .HasColumnType("bit");

                    b.Property<string>("IsSummaryReviewedBy")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("SummaryReviewMethod")
                        .HasMaxLength(20)
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("FormId", "IsActive", "EmployeeId"), new[] { "Amount", "OrderNum" });
            ...
            modelBuilder.Entity("Core.Models.EmployeeNetPay", b =>
                {
                    ...
                    b.HasOne("Core.Models.DailyReference", "DailyReference")
                        .WithMany()
                        .HasForeignKey("DailyReferenceId");
